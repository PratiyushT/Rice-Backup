...
impl TicketStore {
    ...
    pub fn add_ticket(&mut self, draft: TicketDraft) {
        self.tickets.push(Ticket { id: self.id_counter, title: draft.title, description: draft.description, status: Status::ToDo });
    }
}
