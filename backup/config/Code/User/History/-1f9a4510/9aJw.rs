...
impl Ticket {
    ...
    pub fn new(title: String, description: String, status: String) -> Ticket {
        ...
        Ticket {
            title: Ticket::validate_title(title),
            description: Ticket::validate_description(description),
            status: Ticket::validate_status(status),
        }
    }
    ...
    pub fn set_status(&mut self, new_status:String){
        let validataed_status = Ticket::validate_status(new_status);
        self.status = validataed_status;
    }
    pub fn set_description(&mut self, new_desc:String){
        let validataed_desc = Ticket::validate_status(new_desc);
        self.description = validataed_desc;
    }
    pub fn set_title(&mut self, new_title:String){
        let validataed_title = Ticket::validate_status(new_title);
        self.title = validataed_title;
    }
}
