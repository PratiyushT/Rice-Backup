...
impl Ticket {
    ...
    pub fn set_status(&mut self, new_status:String){
        let validated_status = Ticket::validate_status(new_status);
        self.status = validated_status;
    }
    pub fn set_description(&mut self, new_desc:String){
        let validated_desc = Ticket::validate_status(new_desc);
        self.description = validated_desc;
    }
    pub fn set_title(&mut self, new_title:String){
        let validated_title = Ticket::validate_status(new_title);
