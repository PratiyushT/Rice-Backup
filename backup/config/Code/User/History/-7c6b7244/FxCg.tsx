...
export default function Home() {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      const zapierWebhookUrl = process.env.NEXT_PUBLIC_ZAPIER_WEBHOOK_URL || "https://hooks.zapier.com/hooks/catch/23997573/uu7asjk/";
      const zapierSecretKey = process.env.NEXT_PUBLIC_ZAPIER_SECRET_KEY || "artwork-mystery-secret-2024-secure";
      ...
      try {
        ...
        console.log("❌ Zapier webhook error (expected in development):", webhookError);
      }
