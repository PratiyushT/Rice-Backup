...
impl std::error::Error for TicketNewError{} //Error type defined by me. Adding this line tells the compiler that it is a error type.
...
fn easy_ticket(title: String, description: String, status: Status) -> Ticket {
    match Ticket::new(title.clone(), description.clone(), status.clone()){
        ...
        Err(TicketNewError::DescriptionError()) => Ticket { title, description: "Description not provided".to_string(), status }
    }
}
