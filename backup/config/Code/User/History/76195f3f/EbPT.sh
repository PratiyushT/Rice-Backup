...
# Debug: log what Waybar is sending (optional — you can comment this out later)
echo "[kbd-backlight] ARGS: '$*'" >> /tmp/kbd-backlight.log

# --- Robust main logic ---

# If no argument OR empty argument OR --status → show JSON
